...
var endpoint = process.env.ENDPOINT || 'http://84.45.72.169:8080/exist/rest/db/apps/iati-api/xquery/woapi.xq?';
...
var corpus = process.env.CORPUS || 'fullB';
...
function makeRequest() {
  ...
  requester.get({uri:this.api_url, timeout:60000}, function (error, response, body) {
