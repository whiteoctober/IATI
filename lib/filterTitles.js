...
/*
  ...
  into something like :
    ...
    { SectorCategory: { '210:'TRANSPORT AND STORAGE'}, Funder: { 'GB': 'UNITED KINGDOM' } }
...
Request.prototype.end = function(){
  ...
  var requests = _(this.filters).chain().keys()
    ...
    .map(function(key){
      ...
      return api.Request({groupby:key, result:'values', pagesize:2000})
  ...
  var end = function(){
    ...
    _.each(_this.filters, function(value, key){
      ...
      var obj = {};
      _(_.isArray(value) ? value : [value]).each(function(k2){
        obj[k2] = data[key] && data[key][k2] ? data[key][k2] : '--';
      })
